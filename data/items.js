const items = [
    ...
    {name:'Words of the Wind',id:'bk_words_of_the_wind',cost:45,weight:4},
    {name:'Ashland Hymns',id:'bk_Ashland_Hymns',cost:35,weight:4},
    {name:'The Five Far Stars',id:'bk_five_far_stars',cost:25,weight:3},
    {name:'Bonebiter Bow of Sul-Senipul',id:'bonebiter_bow_unique',cost:105,weight:2},
    {name:'The Lost Prophecy',id:'bk_thelostprophecy',cost:0,weight:0.2},
    {name:'Dwemer Coherer',id:'misc_dwrv_artifact50',cost:60,weight:40},
    {name:'Dwemer Boots of Flying',id:'dwemer_boots of flying',cost:470,weight:20},
    {name:'Note to Amaya',id:'bk_NoteToAmaya',cost:0,weight:0},
    {name:'Scroll of Divine Intervention',id:'sc_divineintervention',cost:63,weight:1},
